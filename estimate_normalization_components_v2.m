...
function [c, g, history] = estimate_normalization_components_v2(m_ij, s_ij, S_ij, LOR_indices, i_crys, j_crys, n_crystals, n_crystals_one_side, max_iter, threshold)
...
for iter = 1:max_iter
    ...
    % %end
    %g=-100;
    l_indices_1 = S_ij{1,1}; % S_ij: cell array with list of LOR indices for each i,j pair
    disp(l_indices_1);
